# Saint Cards Effects (PSCT)

Este documento compila las cartas nombradas en `archetype_saint_athena.md` con una redaccion PSCT en ingles lista para adaptar a EDOPro.
...
You can only use each effect of "Saint - Seiya de Pegaso" once per turn.
```
...
Also, for the rest of this turn after this effect resolves, you cannot Special Summon from the Extra Deck, except "Saint" monsters.
If this card is sent to the GY as material for the Summon of a "Saint" monster: You can either equip 1 "Cloth" card you control to that monster, or attach 1 "Cloth" card you control to it as material (if it is an Xyz Monster).
You can only use each effect of "Saint - Shiryu de Dragon" once per turn.
```
...
Also, for the rest of this turn after this effect resolves, you cannot Special Summon from the Extra Deck, except "Saint" monsters.
If this card is sent to the GY as material for the Summon of a "Saint" monster: You can either equip 1 "Cloth" card you control to that monster, or attach 1 "Cloth" card you control to it as material (if it is an Xyz Monster).
You can only use each effect of "Saint - Hyoga de Cisne" once per turn.
```
...
Also, for the rest of this turn after this effect resolves, you cannot Special Summon from the Extra Deck, except "Saint" monsters.
If this card is sent to the GY as material for the Summon of a "Saint" monster: You can either equip 1 "Cloth" card you control to that monster, or attach 1 "Cloth" card you control to it as material (if it is an Xyz Monster).
You can only use each effect of "Saint - Shun de Andromeda" once per turn.
```
...
Also, for the rest of this turn after this effect resolves, you cannot Special Summon from the Extra Deck, except "Saint" monsters.
If this card is sent to the GY as material for the Summon of a "Saint" monster: You can either equip 1 "Cloth" card you control to that monster, or attach 1 "Cloth" card you control to it as material (if it is an Xyz Monster).
You can only use each effect of "Saint - Ikki de Fenix" once per turn.
```
...
You can only use each effect of "Kiki - El Mensajero del Escultor de Armaduras" once per turn.
```
...
Once per turn: You can target 1 "Cloth" card in your GY; attach it to this card as material.
You can only use each effect of "Gold Saint - Shaka de Virgo" once per turn.
```

### Gold Saint - Saga de Geminis
- **Card Type**: Xyz Monster
- **Attribute**: LIGHT
- **Type**: Warrior
- **Rank**: 8
...
### Gold Saint - Dohko de Libra - Maestro de los Cinco Picos
- **Card Type**: Xyz Monster
- **Attribute**: EARTH
- **Type**: Warrior
- **Rank**: 4
...
Once per turn: You can target 1 "Cloth" card in your GY; attach it to this card as material.
You can only use each effect of "Gold Saint - Dohko de Libra - Maestro de los Cinco Picos" once per turn.
```

### Gold Saint - Aldebaran de Tauro
- **Card Type**: Xyz Monster
- **Attribute**: EARTH
- **Type**: Warrior
- **Rank**: 4
...
### Gold Saint - Mascara de Muerte de Cancer
- **Card Type**: Xyz Monster
- **Attribute**: DARK
- **Type**: Warrior
- **Rank**: 4
...
Once per turn: You can target 1 "Cloth" card in your GY; attach it to this card as material.
You can only use each effect of "Gold Saint - Milo de Escorpio" once per turn.
```
...
### Gold Saint - Aiolos de Sagitario
- **Card Type**: Xyz Monster
- **Attribute**: LIGHT
- **Type**: Warrior
- **Rank**: 8
...
If the equipped monster is "Saint - Seiya de Pegaso", it can make up to 2 attacks on monsters during each Battle Phase, also if it destroys an opponent's monster by battle: Inflict 500 damage to your opponent.
...
You can only use 1 effect of "Bronze Cloth - Pegaso" per turn, and only once that turn.
```
...
If the equipped monster is "Saint - Shiryu de Dragon", your opponent cannot target it with card effects.
...
If the equipped monster is "Saint - Hyoga de Cisne", monsters negated by this card's effect cannot change their battle positions, also they cannot be used as material for a Special Summon from the Extra Deck while this card is face-up on the field.
If this face-up Equip Card in its owner's Spell & Trap Zone is sent to the GY: You can target 1 "Saint" monster you control; during your next Standby Phase, equip this card to that target, but banish it when it leaves the field.
You can only use 1 effect of "Bronze Cloth - Cisne" per turn, and only once that turn.
```
...
If the equipped monster is "Saint - Shun de Andromeda", while it is in Defense Position, your opponent cannot declare attacks on other monsters you control, also they cannot activate the effects of monsters that were Special Summoned this turn.
If this face-up Equip Card in its owner's Spell & Trap Zone is sent to the GY: You can target 1 "Saint" monster you control; during your next Standby Phase, equip this card to that target, but banish it when it leaves the field.
...
If the equipped monster is "Saint - Ikki de Fenix", and it would be sent to the GY: You can destroy this card instead, and if you do, Special Summon that monster, then you can destroy 1 card on the field.
If this face-up Equip Card in its owner's Spell & Trap Zone is sent to the GY: You can target 1 "Saint" monster you control; during your next Standby Phase, equip this card to that target, but banish it when it leaves the field.
You can only use 1 effect of "Bronze Cloth - Fenix" per turn, and only once that turn.
```
...
If the equipped monster is "Saint - Jabu de Unicornio", you gain this effect.
...
If this face-up Equip Card in its owner's Spell & Trap Zone is sent to the GY: You can target 1 "Saint" monster you control; during your next Standby Phase, equip this card to that target, but banish it when it leaves the field.
You can only use 1 effect of "Bronze Cloth - Unicornio" per turn, and only once that turn.
```
...
If the equipped monster is "Saint - Ichi de Hidra", and it attacks directly, your opponent cannot activate effects in the GY until the end of this turn.
If this face-up Equip Card in its owner's Spell & Trap Zone is sent to the GY: You can target 1 "Saint" monster you control; during your next Standby Phase, equip this card to that target, but banish it when it leaves the field.
You can only use 1 effect of "Bronze Cloth - Hidra" per turn, and only once that turn.
```
...
If the equipped monster is "Saint - Geki de Oso", at the start of the Damage Step, if it battles an opponent's monster with higher ATK: You can destroy that opponent's monster.
If this face-up Equip Card in its owner's Spell & Trap Zone is sent to the GY: You can target 1 "Saint" monster you control; during your next Standby Phase, equip this card to that target, but banish it when it leaves the field.
...
If the equipped monster is "Silver Saint - Marin de Aguila", once per turn, when your opponent activates a card or effect: You can add 1 Level 4 "Saint" monster from your Deck to your hand.
```
...
If the equipped monster is "Silver Saint - Shaina de Ofiuco", it can attack all monsters your opponent controls, once each.
```
...
If the equipped monster is "Silver Saint - Algol de Perseo", at the start of your opponent's turn: You can choose 1 Main Monster Zone; while this card is face-up on the field, that zone cannot be used.
```
...
If the equipped monster is "Saint - Seiya de Pegaso" or "Gold Saint - Aiolos de Sagitario", when it declares an attack, your opponent cannot activate cards or effects until the end of the Battle Phase.
If this card is in your GY: You can target 1 "Bronze Saint" monster you control; equip this card to it, and if you do, it becomes Level 8. You can only use this effect of "Gold Cloth - Sagitario" once per turn.
```
...
While this card is equipped to "Gold Saint - Afrodita de Piscis", your opponent must keep their hand revealed.
```
...
### El Torneo Galactico (Continuous Spell)
...
### Orden de Asesinato del Santuario (Normal Spell)
- **Card Type**: Normal Spell
...
You can only use this GY effect of "Orden de Asesinato del Santuario" once per turn.
```
...
### El Despertar del Cosmos (Quick-Play Spell)
...
You can only activate 1 "El Despertar del Cosmos" per turn.
```

### Legado del Maestro (Normal Spell)
- **Card Type**: Normal Spell
...
```text
Add 1 Level 4 or lower "Saint" monster from your Deck to your hand, or if you control no monsters, you can add 1 "Kiki - El Mensajero del Escultor de Armaduras" instead.
You can only activate 1 "Llamado de Athena" per turn.
```
...
Also, for the rest of this turn after this card resolves, you cannot Special Summon from the Extra Deck, except "Saint" monsters.
You can only activate 1 "Entrenamiento en el Santuario" per turn.
```
...
You can only activate 1 "Meditacion en Star Hill" per turn.
```
...
You can only activate 1 "Vinculo de Hermandad" per turn.
```
...
You can only activate 1 "Cometa de Pegaso" per turn.
```
...
You can only activate 1 "Tormenta Nebular" per turn.
```
...
You can only use this effect of "Intervencion de Cassios" once per turn.
```
...
You can only use this effect of "Marin - Guia del Aprendiz" once per turn.
```
...
You can only use this effect of "Shaina - Cobra Paralizante" once per turn.
```
...
You can only use this effect of "Tatsumi - Guardian de la Mansion" once per turn.
```
...
If you control "Gold Saint - Mu de Aries", you can activate this card from your hand by discarding 1 "Cloth" card.
You can only activate 1 "Muro de Cristal" per turn.
```
...
You can only activate 1 "Defensa Circular" per turn.
```
...
You can only activate 1 "El Veredicto del Patriarca" per turn.
```
