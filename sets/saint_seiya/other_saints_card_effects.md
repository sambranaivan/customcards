# Other Saints Card Effects (PSCT)

Este archivo (`other_saints_card_effects.md`, antes `saint_cards_effects.md`) compila cartas nombradas en `archetype_saint_athena.md` con PSCT en ingles para adaptar a EDOPro — incluye lineas aun no reflejadas en `expansions/saint-seiya.cdb`. Los nombres siguen unificados en ingles para Saint Seiya.
...
If the equipped monster is "Saint - Seiya of Pegasus" or "Gold Saint - Aiolos of Sagittarius", when it declares an attack, your opponent cannot activate cards or effects until the end of the Battle Phase.
...
### Steel Saint - Sho of the Sky Armor
- **Card Type**: Effect Monster
- **Attribute**: WIND
- **Type**: Machine
- **Level**: 4
...
You can only use this effect of "Steel Saint - Sho of the Sky Armor" once per turn.
```
