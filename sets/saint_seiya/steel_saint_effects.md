...
## Identity and Design Rules

- Rol principal: **handtraps y proteccion** para sostener jugadas de Bronze/Silver.
- Restriccion de balance: tras resolver efectos Steel, bloqueo suave al Extra Deck para evitar abuso fuera de `"Saint"`.
- Filosofia: cartas de tempo (1x1), no motores de ventaja desmedida.
...
## Deck Use Notes (Saint + Steel)

- 3-6 espacios recomendados para Steel (2-3 monstruos + 1-3 soporte).
- Entran mejor en builds Saint de control/tempo, especialmente con Silver Saints.
- Objetivo: proteger la pieza central del turno Saint y forzar intercambios favorables en turno rival.
