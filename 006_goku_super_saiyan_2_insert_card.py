...
# Super Saiyan 3 Goku - 900000014 (placeholder)
# Warrior / Effect / Fusion, LIGHT, Level 10, ATK 4200 / DEF 3800
c.execute('INSERT OR REPLACE INTO datas VALUES (?,?,?,?,?,?,?,?,?,?,?)',
    (900000014, 4, 0, GOKU_SETCODE, TYPE_FUSION_EFFECT, 4200, 3800, 10, 1, 16, 0))
c.execute('INSERT OR REPLACE INTO texts VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)',
